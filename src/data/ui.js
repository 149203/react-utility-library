export const uiData = [
   ...
   },
   {
      name: "countCard",
      desc:
         "Counting cards. Start with a count of 0. Put in a new card and see the count change and whether to bet or not.",
      inputs: 1,
      type: "intermediate",
      typeNum: 200,
      isFavorite: false,
   ...
   },
   {
      name: "updateRecords",
      desc:
         "Updates a record in your collection. You can keep adding and updating records but if you refresh the page your collection will reset to the default.",
      inputs: 3,
      type: "intermediate",
      typeNum: 200,
      isFavorite: false,
   ...
   },
   {
      name: "iterateBy",
      desc:
         "This will return a list of numbers from start to end incrementing by increment.",
      inputs: 3,
      type: "intermediate",
      typeNum: 200,
      isFavorite: false,
   ...
   },
   {
      name: "randomRange",
      desc:
         "Get a random integer between myMin and myMax inclusive. Optional: add an amount of numbers to generate in the third column.",
      inputs: 3,
      type: "intermediate",
      typeNum: 200,
      isFavorite: false,
   ...
   },
   {
      name: "urlSlug",
      desc:
         "Convert the title string to a lowercase url slug with hyphens instead of spaces.",
      inputs: 1,
      type: "functional",
      typeNum: 300,
      isFavorite: false,
   ...
   },
   {
      name: "findElement",
      desc:
         "This looks through an array and returns the first element that passes the function func = (num) => num % 2 === 0.",
      inputs: 1,
      type: "algorithm",
      typeNum: 400,
      isFavorite: false,
   ...
   },
   {
      ...
      desc:
         "This splits an array (first argument) into groups the length of size (second argument) and returns them as a two-dimensional array. Look at the console to verify that its a 2D array.",
      inputs: 2,
      type: "algorithm",
      typeNum: 400,
      isFavorite: false,
